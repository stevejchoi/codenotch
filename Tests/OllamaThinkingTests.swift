...
final class OllamaThinkingActivityTests: XCTestCase {
    ...
    func testOnlyMatchingModelUsesExistingActivityArcOnEveryEdge() throws {
        let reading = try OllamaUsage.parse(Data(#"{"models":[{"name":"gemma4:e4b","size":9610000000},{"name":"qwen3:0.6b","size":675576545}]}"#.utf8))
        let snapshot = ProviderSnapshot(id: "ollama", displayName: "Ollama", glyph: .ollama,
        ...
        XCTAssertNil(model.activity(for: "ollama"))
